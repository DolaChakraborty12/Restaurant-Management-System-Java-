...
public class Addk extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String str="INSERT INTO signup.menu1(Menu_id,Item_name,Category,price) values(?,?,?,?)";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Addk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
